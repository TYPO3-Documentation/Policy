...
Short link to this page: `typo3.org/coc <https://typo3.org/coc>`__
...
.. _coc-faq-advice2-question1:

1. Where should I ask for help?
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

This depends on context, but feel free to ask the community—even if your question is “where do I ask for help about this”. The `Help and Support page <https://typo3.org/help>`__ has some good suggestions.

.. _coc-faq-advice2-question2:
...
Thank you for the suggestion. We believe promises can be hard to keep in certain life situations. Also, volunteer contributors have no contractual obligations. That doesn't mean promises have no value (on the contrary, they should be highly valued), but it is a tough rule if you consider the words of the :ref:`Applicability and Scope <applicability-and-scope>` section: “The Basic Rules are binding and should always be followed. Going against them will have consequences.”

.. _coc-feedback-preface:

Preface
-------

.. _coc-feedback-preface-question1:
...
Your differentiation between a gift and an obligation makes sense. To keep it short and sweet and align it with the updated :ref:`Basic Rule #1 <coc-basic-rules>`, we will change the last sentence in the second paragraph of the preface to “However, you also have the responsibility to treat people with respect.”
...
.. _coc-feedback-advice4:

General advice #4: Be respectful …
----------------------------------

.. _coc-feedback-advice4-question1:
...
.. _coc-feedback-advice4-question2:
...
It is great to hear that you like the proposal. Thank you. We have answered :ref:`a similar question <coc-feedback-advice4-question1>` regarding respect for time above.

.. _coc-feedback-advice5:

General advice #5: Be positive …
--------------------------------

.. _coc-feedback-advice5-question1:
...
.. _coc-feedback-advice5-question2:
...
.. _coc-feedback-handling-violations:

Handling violations
-------------------

.. _coc-feedback-handling-violations-question1:
...
.. _coc-feedback-handling-violations-question2:
...
.. _coc-feedback-handling-violations-question3:
...
* *Getting a clean record and a second chance:* All decisions can be appealed to the TYPO3 Association board (:ref:`Due Process and Right to Appeal <coc-process-appeal>`). Reactions are always time-limited. There will be no permanent exclusions, etc. (:ref:`Reactions to Violations <coc-reactions>`)
* *Using the code of conduct to shut down people:* This should never happen. Everyone have “the right to [their] own personal views and values” (:ref:`Preface <coc-preface>`), though TYPO3 is not a political arena and though you can have any view or and value, you don't have to say everything you think.
* *A tool for guidance and nudging towards better behavior:* The person who is suspected of having violated the Code of Conduct has a right to be heard during the review process (:ref:`Due Process and Right to Appeal <coc-process-appeal>`). A good review process means trying to include the reported person in a way that is positive for everyone. The type of reaction will depend on the type of violation, but are supposed to start at “a formal warning” (:ref:`Reactions to Violations <coc-reactions>`).
