:navigation-title: Voting Procedure
...
Any individual can apply for positions in the TYPO3 Association. The nomination must be received via the nomination form (`https://voting.typo3.org <https://voting.typo3.org>`__) within the period of the nomination phase.
...
#. Candidate Eligibility: To be accepted as a candidate, the nominee must provide proof of personal membership (Community or Bronze).
#. Election Threshold: A candidate must receive more than 50% of the votes cast to be elected.
#. Order of Election: Candidates who reach the required majority are elected in order of their vote counts.
